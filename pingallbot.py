...
Don't forget to join my [channel](https://t.me/All_Hindi_Anime) to recieve information on all the latest updates.
...
If you have any questions on how to use me, feel free to ask in my [support group](https://t.me/botsupportx).
'''
  await teletips.send_message(message.chat.id, text, disable_web_page_preview=True)
